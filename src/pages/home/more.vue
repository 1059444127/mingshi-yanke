<template>
    <div class="index-more" ref="more">
        <ul class="overflow-hidden">
            <li class="float-left center flex" @click="downloadApp" :style="liStyle" v-for="nav in list">
...
<script>
    ...
    import {scrollHeightMixin, guideAppMixin} from "../../lib/mixin"
    ...
    export default {
        ...
        mixins: [scrollHeightMixin, guideAppMixin],
        components: {},
        mounted() {
            this.init();
        },

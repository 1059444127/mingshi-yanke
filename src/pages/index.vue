<template>
  <div class="page index">
    <div class="wrapper overflow-hidden" ref="main">
      <div class="banner swiper-container overflow-hidden" ref="swiper">
      ...
      <ul class="nav flex">
        <router-link replace :key="index" :to="nav.path" tag="li" exact-active-class="current"
                     class="flex0 center"

<template>
  <div class="page flex doc">
    ...
    <div class="main flex1 overflow-y-auto" ref="main">
      ...
      <ul class="flex nav">
        <li v-for="nav in navs" class="flex0 center" :class="[nav.name]">
          <div class="icon"></div>
      ...
      <div class="wrap">
        ...
        <div class="content" v-html="doc.docSkill"></div>
      </div>
      <div class="wrap">
        <div class="title">医生介绍</div>
        <div class="content" v-html="doc.docResume"></div>
      </div>
      <div class="wrap">
